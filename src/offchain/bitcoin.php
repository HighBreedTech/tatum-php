 ...
 */
function sendBitcoinOffchainTransaction(testnet: boolean, body: TransferBtcBasedOffchain) {
 ...
 */
function signBitcoinOffchainKMSTransaction(tx: TransactionKMS, $mnemonic, testnet: boolean) {

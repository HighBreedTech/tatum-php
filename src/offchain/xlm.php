 ...
 */
function sendXlmOffchainTransaction(testnet: boolean, body: TransferXlmOffchain) {
 ...
 */
function signXlmOffchainKMSTransaction(tx: TransactionKMS, $secret, testnet: boolean) {
...
(testnet: boolean, account: any, $amount, $address, $secret, memo?: Memo) {

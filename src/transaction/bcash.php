 ...
 */
function sendBitcoinCashTransaction(testnet: boolean, body: TransferBchBlockchain) {
 ...
 */
function signBitcoinCashKMSTransaction(tx: TransactionKMS, privateKeys: string[], testnet: boolean) {
 ...
 * @returns transaction data to be broadcast to blockchain.
 */
function prepareBitcoinCashSignedTransaction(testnet: boolean, body: TransferBchBlockchain) {
...
const getTransactions = (txHash: string[]): Promise<BchTx[]> => {
    const result = [];

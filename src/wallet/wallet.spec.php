...
describe('Address tests', () => {
    ...
    it('should generate wallet for BTC mainnet', () => {
    ...
    it('should generate wallet for BTC testnet', () => {
    ...
    it('should generate wallet for LTC mainnet', () => {
    ...
    it('should generate wallet for LTC testnet', () => {
    ...
    it('should generate wallet for BCH mainnet', () => {
    ...
    it('should generate wallet for BCH testnet', () => {
    ...
    it('should generate wallet for ETH mainnet', () => {
    ...
    it('should generate wallet for ETH testnet', () => {
    ...
    it('should generate wallet for VET mainnet', () => {
    ...
    it('should generate wallet for VET testnet', () => {
